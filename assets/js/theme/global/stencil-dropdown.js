export default class StencilDropdown {
    ...
    hide($dropDown, style) {
        ...
        $dropDown.removeClass('is-open f-open-dropdown').attr('aria-hidden', 'true').attr('inert', '');
    }

    show($dropDown, event, style) {
        if (style) {
            $dropDown.attr('style', style).attr('aria-hidden', 'false').removeAttr('inert');
        }

        $dropDown.addClass('is-open f-open-dropdown').attr('aria-hidden', 'false').removeAttr('inert');
