...
export default class ContentfulCareersPage extends ContentfulAbstract {
    constructor(context) {
        super(context);
    ...
    populateContent() {
        ...
        if (this.page_entry !== null) {
            ...
            if (this.validateFieldData(this.page_entry.content, 'text')) {
                if (document.querySelector('.careers-container .page-content') !== null) {
                    document.querySelector('.careers-container .page-content').innerHTML = converter.makeHtml(this.page_entry.content);
                }
            }
        }
    }
